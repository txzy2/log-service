...
import {FileCog, MonitorCog, User} from 'lucide-vue-next';
...
<template>
    <div>
        ...
        <div class="min-h-screen text-black/50 dark:bg-gray dark:text-black/50">
            <nav class="dark:bg-gray-200 dark:text-black/50 border-b border-gray-100">
